const result = document.querySelector('#res'),
      expression = document.querySelector('#expr'),
      engineer = document.querySelectorAll('.eng'),
      number = document.querySelectorAll('.num:not(.equals)'),
      operation = document.querySelectorAll('.oper'),
